...
/**
 * Start of random specific utilities
*/
const double P_RANDOM = 0.5;
inline int score_random() {
...
// End of random specific utilities
    ...
    void partition()
    {
        ...
        std::thread producer([&]()
            ...
            for (int i = 1; i <= vertex_count; i++) {
                ...
                double buffer_score = score_random();

                if (draw_random() < P_RANDOM) {
